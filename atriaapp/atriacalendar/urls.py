...
urlpatterns = [
    ...
    path('calendar/<int:year>/', atria_year_view,
         name='swingtime-yearly-view'),
    path('calendar/<int:year>/<int:month>/', atria_month_view,
         name='swingtime-monthly-view'),
    path('calendar/<int:year>/<int:month>/<int:day>/', atria_day_view,
    ...
    path('event-detail/<int:pk>/', EventUpdateView.as_view(),
